...
<head>
    ...
    <link rel="icon" href="{{ asset('front/images/favicon/favicon-16x16.png') }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('front/images/favicon/favicon-16x16.png') }}" type="image/x-icon">
...
<script src="{{ asset('back/assets/js/sidebar-pin.js') }}"></script>
