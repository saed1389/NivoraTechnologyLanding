...
<head>
    ...
    <title>{{ $title ?? 'Nivora Technology OÜ' }} - {{ __('all.IT Consulting Estonia') }}</title>
        ...
        <div class="flex justify-between items-center h-20">
            <div class="flex items-center">
                <a href="{{ route('home') }}" wire:navigate class="flex items-center gap-2">
                    <img src="{{ asset('front/images/logo.png') }}" alt="Nivora Technology OÜ" class="h-10 md:h-12 w-auto object-contain"/>
                </a>
            </div>
            <div class="hidden md:flex items-center space-x-2">
                ...
                <div class="flex justify-center border-gray-100"
                    ...
                    <div class="relative w-32">
                        <button @click="open = !open" @click.outside="open = false" class="w-full appearance-none bg-gray-50 border border-gray-200 text-gray-700 py-2 px-3 rounded-lg flex items-center justify-between hover:bg-white hover:border-estonia-blue transition-all duration-300">
                            <div class="flex items-center gap-2">
                                <img :src="flags[locale]" class="w-5 h-auto rounded-sm shadow-sm object-cover" alt="">
                        ...
                        >
                            <div class="py-1">
                                <a href="/change-locale/en" class="flex items-center gap-3 px-4 py-2 hover:bg-blue-50 hover:text-estonia-blue transition-colors group">
                                    <img src="https://flagcdn.com/w40/gb.png" class="w-5 h-auto rounded-sm shadow-sm opacity-80 group-hover:opacity-100" alt="">
                                    <span class="text-sm font-medium">English</span>
                                </a>
                                <a href="/change-locale/et" class="flex items-center gap-3 px-4 py-2 hover:bg-blue-50 hover:text-estonia-blue transition-colors group">
                                    <img src="https://flagcdn.com/w40/ee.png" class="w-5 h-auto rounded-sm shadow-sm opacity-80 group-hover:opacity-100" alt="">
                                    <span class="text-sm font-medium">Estonian</span>
                                </a>
                                <a href="/change-locale/ru" class="flex items-center gap-3 px-4 py-2 hover:bg-blue-50 hover:text-estonia-blue transition-colors group">
                                    <img src="https://flagcdn.com/w40/ru.png" class="w-5 h-auto rounded-sm shadow-sm opacity-80 group-hover:opacity-100" alt="">
        ...
        <div class="p-6 space-y-4 flex flex-col">
            ...
            <div class="flex justify-center pt-4 border-t border-gray-100 mt-2"
                ...
                <div class="relative w-full max-w-xs">
                    ...
                    <button @click="open = !open" class="w-full bg-gray-50 border border-gray-200 text-gray-700 py-2 px-4 rounded-lg flex items-center justify-between hover:bg-white hover:border-estonia-blue transition-all">
                        <div class="flex items-center gap-3">
                            <img :src="flags[locale]" class="w-6 rounded-sm shadow-sm">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-600">
                    <li>info@nivoratechnology.ee</li>
                    <li>info@nivoratechnology.com</li>
                    <li>Tartu, Estonia</li>
                </ul>
            </div>
        </div>
